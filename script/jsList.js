/* JsList 1.0 - polyfill zepto detect event ajax form fx fx_methods data assets selector touch - zeptojs.com/license */
(function (a) {
...
window.Zepto = JsList, "$" in window || (window.$ = JsList), function (a) {
    function b(a) {
    ...
    var b = {}, c = a.fn.data, d = a.camelCase, e = a.expando = "JsList" + +(new Date);
    ...
    }, g = new RegExp("(.*):(\\w+)(?:\\(([^)]+)\\))?$\\s*"), h = /^\s*>/, i = "JsList" + +(new Date);
    b.qsa = function (d, e) {
